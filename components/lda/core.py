...
def main(ngram_range: tuple = (1,1), n_components: int = 2, max_inter: int = 100):
    ...
    vectorizer, vectorized_texts = tfid_vectorizer(preproc_texts[0], ngram_range=ngram_range)

    lda_model = lda(vectorized_texts, n_components=n_components, max_iter=max_inter)
